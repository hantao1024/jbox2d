...
public class CollisionModel {
    ...
    private int mVelocityIterations = 3; //速率迭代器
    private int mPosiontIterations = 10; //迭代次数
...
//    private float mFriction = 0.3f;
     ...
     * 刚体的补偿系数
     */
//    private float mRestitution = 0.3f;
    private float mRestitution = 0f;
    ...
    public void createNewWorld() {
        //竖直向下的重力向量
        mWorld = new World(new Vec2(0f, 6.0f));
